    ...
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="space-y-8 mb-16">
        <Step
          ...
          description="Upload a high-resolution JPG, PNG, TIFF, WebP, or BMP file — up to 400 MB and 260 megapixels. The higher the resolution, the more sizes you can produce at print quality."
        />
        <Step
          number="2"
