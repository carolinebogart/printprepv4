    ...
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="space-y-3">
        <FAQItem
          ...
          answer="PrintPrep accepts JPG, JPEG, PNG, TIFF, WebP, and BMP files. Maximum file size is 400 MB, and the image can be up to 260 megapixels (up to 14,400×18,000 pixels)."
        />
        <FAQItem
        ...
        <FAQItem
          ...
          answer="Files over 400 MB or 260 megapixels will be rejected at upload. If your image is large but under the limits, PrintPrep handles the heavy lifting server-side — you don't need a powerful computer."
        />
      </div>
